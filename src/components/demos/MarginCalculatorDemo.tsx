...
export default function MarginCalculatorDemo() {
  ...
  const equityBarColor = (() => {
    if (equityPercent < 30) return '#ef4444';
    if (equityPercent < 50) return '#eab308';
    return '#22c55e';
  })();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ background: '#111', borderRadius: '0.5rem', padding: '0.75rem' }}>
          ...
          <input
            ...
            style={{
              width: '100%',
              accentColor: stockChange >= 0 ? '#22c55e' : '#ef4444',
              height: '4px',
            }}
          />
        </div>
      ...
      >
        <div>
          <div style={{ fontSize: '0.7rem', color: '#888', marginBottom: '0.375rem' }}>
          ...
          >
            ...
            <span style={{ color: '#ef4444', fontFamily: 'monospace', fontSize: '0.85rem' }}>
        ...
        <div>
          ...
          >
            <span style={{ color: '#888', fontSize: '0.8rem' }}>Borrowed</span>
            <span style={{ color: '#22c55e', fontFamily: 'monospace', fontSize: '0.85rem' }}>
              $0
            </span>
          </div>
          <div
          ...
          >
            ...
            <span
              style={{
                color: noLeveragePL >= 0 ? '#22c55e' : '#ef4444',
                fontFamily: 'monospace',
                fontSize: '0.85rem',
                fontWeight: 'bold',
              }}
      ...
      {(isMarginCall || isLiquidated) && (
        ...
        >
          <span
            style={{
              color: isLiquidated ? '#ef4444' : '#eab308',
              fontWeight: 'bold',
              fontSize: '0.85rem',
            }}
          >
      ...
      <p style={{ color: '#666', fontSize: '0.75rem', marginTop: '0.75rem', textAlign: 'center' }}>
        Drag &quot;Stock Move&quot; to see how leverage amplifies both gains AND losses. Watch the
        equity bar — drop below 30% and you get a margin call!
      </p>
    </div>
  );
}
