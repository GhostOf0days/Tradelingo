...
export const TRADING_PRETEST = [
  {
    ...
    options: ['A loan', 'Fractional ownership', 'A physical product', 'Nothing'],
    correctIndex: 1,
  },
  {
    question: 'What is a stock exchange?',
    options: [
      'A digital market to trade stocks',
  ...
  },
  {
    ...
    options: [
      'A watch brand',
      'A 1-5 letter abbreviation for a stock (e.g., AAPL)',
      'A secret code',
  ...
  },
  {
    ...
    options: [
      'Buys the stock instantly at the current price',
      'Waits for a specific price',
      'Cancels a trade',
      'Sells everything',
    ],
    correctIndex: 0,
  ...
  {
    question: "What does 'Volatility' refer to?",
    options: [
      'How loud the trading floor is',
      'The rate at which the price of a stock increases or decreases',
      'Company profits',
      'Number of employees',
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      'Stocks related to poker',
      'Shares of large, industry-leading companies',
      'Cheap penny stocks',
      'Tech startups',
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      'How much market risk you can comfortably handle',
      'A legal document',
