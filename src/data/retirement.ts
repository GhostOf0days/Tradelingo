...
export const RETIREMENT_PRETEST = [
  {
    ...
    options: [
      ...
      'An employer-sponsored retirement plan with tax advantages',
  ...
  {
    question: 'What does an IRA stand for?',
    options: [
      'Individual Retirement Account',
      'International Revenue Administration',
      'Institutional Risk Assessment',
      'Investment Rate Agreement',
    ],
    correctIndex: 0,
  },
  {
    question: 'What is the advantage of a Roth IRA?',
    options: [
      'Higher contribution limits',
      'Tax-free withdrawals in retirement',
      'Government contributions match',
      'Immediate cash back',
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      'An IRA started before 1950',
      'An account where contributions are tax-deductible now but taxed in retirement',
  ...
  },
  {
    ...
    options: [
      'When employer steals your money',
      'Free money employers contribute if you contribute to your 401(k)',
      'A requirement to work longer',
      'Bonus commission',
    ],
    correctIndex: 1,
  },
  {
    question: 'At what age can you withdraw from an IRA without penalties?',
    options: ['50', '55', '59.5', '65'],
    correctIndex: 2,
  },
  {
    question: 'What is the annual contribution limit for a 401(k) in 2024?',
    options: ['$15,500', '$20,500', '$25,500', '$30,000'],
    correctIndex: 1,
  },
  {
    question: 'What is Required Minimum Distribution (RMD)?',
    options: [
      'Minimum you must save each month',
      'Mandatory withdrawal from retirement accounts after age 73',
      'A monthly insurance fee',
      'The amount to retire comfortably',
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      ...
      'A government program providing income for retired, disabled, and surviving workers',
      'A bank service',
  ...
  },
  {
    ...
    options: [
      'To work less',
      'To have enough income to maintain your lifestyle when you stop working',
  ...
  },
  {
    ...
    options: [
      'Spend 4% of your paycheck',
      'Withdraw 4% of your retirement portfolio in year 1, then adjust for inflation',
      'Work 4% of the year',
      'Invest 4% in bonds',
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      ...
      'Regular payments made by an employer to an employee after retirement',
      'A government tax',
      'Life insurance',
    ],
    correctIndex: 1,
